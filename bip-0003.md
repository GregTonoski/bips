...
The [BIPs repository](https://github.com/GregTonoski/bips/) serves as a publication medium and archive for mature proposals.
...
the novelty and viability of the idea should be checked against ideas shared in various sources, e.g. [Bitcoin Development Mailing
...
A Process BIP may change status from Complete to Deployed. [^living-documents]
...
authors’ announcement. However, if someone volunteers to adopt the proposal
...
A BIP may evolve from Deployed to Closed when it is no longer in active use.
...
* Greg Tonoski ([greg.tonoski@gmail.com](mailto:greg.tonoski@gmail.com))

### BIP Editor Responsibilities and Workflow

The BIP Editors watch the [BIPs
repository](https://github.com/GregTonoski/bips).

BIP Editors or other community members are encouraged to comment in regard
to:

* Novelty of proposed ideas,
* Viability, utility, and relevance of concepts,
...
repository](https://github.com/GregTonoski/bips) where it may get further feedback.
...
* __1.5.0__ (2026-08-13):
    * Discard Bitcoin dev mailing list pre-requisite, update URL to the BIP repository
